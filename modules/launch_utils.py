...
def prepare_environment():
    ...
    assets_repo = os.environ.get('ASSETS_REPO', "https://github.com/Dimferon/sd-webui-assets.git")
    stable_diffusion_repo = os.environ.get('STABLE_DIFFUSION_REPO', "https://github.com/Dimferon/stable-diffusion-base")
    stable_diffusion_xl_repo = os.environ.get('STABLE_DIFFUSION_XL_REPO', "https://github.com/Stability-AI/generative-models.git")
    k_diffusion_repo = os.environ.get('K_DIFFUSION_REPO', 'https://github.com/Dimferon/sd-k-diffusion.git')
